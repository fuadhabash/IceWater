...
main(){
    ...
    printf("------------------------------------------------\n");
    printf("This is a program to emulate the 8-bit Ice Water\n");
    printf("------------------------------------------------\n\n\n");
    ...
    printf("Operations - 00: Add, 01: Sub, 02, Mult, 04 Div\n");
    printf("Status - 00: OK, 01: Overflow, 02: Underflow, 03: Decimal, 04: Zero Division.\n\n");
    ...
    for(i=0; i<eqn_num; i++){
        ...
        case 03: // Division
            ...
            if (eqns[i].rs2==0){
                eqns[i].status=4;
                printf("Can't divide by Zero! - status: %02x\n", eqns[i].status);
